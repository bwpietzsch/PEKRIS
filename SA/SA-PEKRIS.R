...
# test fo normal distributions
lm1 <- lm(max_abundance_salp_season~(chla_supply+vegetation_delay+oozoid_respiration+krill_amount+chla_growth+salp_immigration_probability+salp_mortality+krill_mortality+blastozoid_respiration+salp_amount+chla_decay+salp_length+salp_starvation+krill_hibernation+salp_halfsat+krill_halfsat)^2,df)
shapiro.test(resid(lm1))
...
# test for normal distribution
lm1 <- lm(median_abundance_salp_overall~(chla_supply+vegetation_delay+oozoid_respiration+krill_amount+chla_growth+salp_immigration_probability+salp_mortality+krill_mortality+blastozoid_respiration+salp_amount+chla_decay+salp_length+salp_starvation+krill_hibernation+salp_halfsat+krill_halfsat)^2,df)
...
## krill eggs ##
# test for normal distribution
lm1 <- lm(sum_eggs_krill~(chla_supply+vegetation_delay+oozoid_respiration+krill_amount+chla_growth+salp_immigration_probability+salp_mortality+krill_mortality+blastozoid_respiration+salp_amount+chla_decay+salp_length+salp_starvation+krill_hibernation+salp_halfsat+krill_halfsat)^2,df)
...
## mean length krill
# test for normal distribution
lm1 <- lm(mean_length_krill~(chla_supply+vegetation_delay+oozoid_respiration+krill_amount+chla_growth+salp_immigration_probability+salp_mortality+krill_mortality+blastozoid_respiration+salp_amount+chla_decay+salp_length+salp_starvation+krill_hibernation+salp_halfsat+krill_halfsat)^2,df)
...
## abundance krill
# test for normal distribution
lm1 <- lm(abundance_krill~(chla_supply+vegetation_delay+oozoid_respiration+krill_amount+chla_growth+salp_immigration_probability+salp_mortality+krill_mortality+blastozoid_respiration+salp_amount+chla_decay+salp_length+salp_starvation+krill_hibernation+salp_halfsat+krill_halfsat)^2,df)
